...
const initializeDemoData = () => {
  ...
  if (users.length === 0) {
    const demoUsers: User[] = [
      ...
      {
        uid: 'worker-001',
        email: 'welder1@peninsulaequine.com.au',
        displayName: 'Jake Morrison (Welder)',
        role: 'worker',
        password: 'Peninsula2024!',
        createdAt: new Date().toISOString(),
        approvedAt: new Date().toISOString(),
      ...
      {
        uid: 'worker-002',
        email: 'carpenter1@peninsulaequine.com.au',
        displayName: 'Steve Parker (Carpenter)',
        role: 'worker',
        password: 'Peninsula2024!',
        createdAt: new Date().toISOString(),
        approvedAt: new Date().toISOString(),
      ...
      {
        uid: 'worker-003',
        email: 'fabricator1@peninsulaequine.com.au',
        displayName: 'Tony Richards (Steel Fabricator)',
        role: 'worker',
        password: 'Peninsula2024!',
        createdAt: new Date().toISOString(),
        approvedAt: new Date().toISOString(),
      ...
      {
        uid: 'worker-004',
        email: 'operator1@peninsulaequine.com.au',
        displayName: 'Paul Mitchell (Excavator Operator)',
        role: 'worker',
        password: 'Peninsula2024!',
        createdAt: new Date().toISOString(),
        approvedAt: new Date().toISOString(),
      ...
      {
        uid: 'worker-005',
        email: 'driver1@peninsulaequine.com.au',
        displayName: 'Ben Clarke (Truck Driver)',
        role: 'worker',
        password: 'Peninsula2024!',
        createdAt: new Date().toISOString(),
        approvedAt: new Date().toISOString(),
      ...
      {
        uid: 'worker-006',
        email: 'labourer1@peninsulaequine.com.au',
        displayName: 'Chris Anderson (Labourer)',
        role: 'worker',
        password: 'Peninsula2024!',
        createdAt: new Date().toISOString(),
        approvedAt: new Date().toISOString(),
      ...
      {
        uid: 'worker-007',
        email: 'apprentice1@peninsulaequine.com.au',
        displayName: 'Sam Johnson (Apprentice)',
        role: 'worker',
        password: 'Peninsula2024!',
        createdAt: new Date().toISOString(),
        approvedAt: new Date().toISOString(),
      ...
      {
        uid: 'worker-008',
        email: 'electrician1@peninsulaequine.com.au',
        displayName: 'Michael Brown (Electrician)',
        role: 'worker',
        password: 'Peninsula2024!',
        createdAt: new Date().toISOString(),
        approvedAt: new Date().toISOString(),
      ...
      {
        uid: 'worker-009',
        email: 'plumber1@peninsulaequine.com.au',
        displayName: 'Robert Taylor (Plumber)',
        role: 'worker',
        password: 'Peninsula2024!',
        createdAt: new Date().toISOString(),
        approvedAt: new Date().toISOString(),
