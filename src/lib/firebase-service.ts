  ...
  if (users.length === 0) {
    const demoUsers: User[] = [
      // Management & Administration
      {
        ...
        displayName: 'Ciro Casa (Director)',
        role: 'admin',
        password: 'peninsula25',
      ...
      },
      {
        ...
        displayName: 'Tam Casa (Operations Manager)',
        role: 'admin',
        password: 'peninsula25',
        createdAt: new Date().toISOString(),
        mustChangePassword: false,
      ...
      {
        uid: 'admin-003',
        email: 'jordynn@peninsulaequine.com.au',
        displayName: 'Jordynn (Admin)',
        role: 'admin',
        password: 'peninsula25',
        createdAt: new Date().toISOString(),
        mustChangePassword: false,
      ...
      {
        uid: 'admin-004',
        email: 'office@peninsulaequine.com.au',
      ...
      {
        uid: 'supervisor-001',
        email: 'supervisor1@peninsulaequine.com.au',
        displayName: 'Mark Thompson (Site Supervisor)',
        role: 'worker',
        password: 'peninsula25',
        createdAt: new Date().toISOString(),
      ...
      {
        uid: 'supervisor-002',
        email: 'supervisor2@peninsulaequine.com.au',
        displayName: 'David Wilson (Construction Lead)',
        role: 'worker',
        password: 'peninsula25',
        createdAt: new Date().toISOString(),
        approvedAt: new Date().toISOString(),
      ...
      {
        uid: 'worker-001',
        email: 'phil@peninsulaequine.com.au',
        displayName: 'Phil (Welder/Fabricator)',
        role: 'worker',
        password: 'peninsula25',
        createdAt: new Date().toISOString(),
        approvedAt: new Date().toISOString(),
      ...
      {
        uid: 'worker-002',
        email: 'saunder@peninsulaequine.com.au',
        displayName: 'Saunder (Construction/General)',
        role: 'worker',
        password: 'peninsula25',
        createdAt: new Date().toISOString(),
        approvedAt: new Date().toISOString(),
      ...
      // Available slots for new workers - easily customizable
      {
        uid: 'worker-003',
        email: 'james@peninsulaequine.com.au',
        displayName: 'James (Available Position)',
        role: 'worker',
        password: 'peninsula25',
        createdAt: new Date().toISOString(),
        approvedAt: new Date().toISOString(),
      ...
      {
        uid: 'worker-004',
        email: 'michael@peninsulaequine.com.au',
        displayName: 'Michael (Available Position)',
        role: 'worker',
        password: 'peninsula25',
        createdAt: new Date().toISOString(),
        approvedAt: new Date().toISOString(),
      ...
      {
        uid: 'worker-005',
        email: 'david@peninsulaequine.com.au',
        displayName: 'David (Available Position)',
        role: 'worker',
        password: 'peninsula25',
        createdAt: new Date().toISOString(),
        approvedAt: new Date().toISOString(),
      ...
      {
        uid: 'worker-006',
        email: 'steve@peninsulaequine.com.au',
        displayName: 'Steve (Available Position)',
        role: 'worker',
        password: 'peninsula25',
        createdAt: new Date().toISOString(),
        approvedAt: new Date().toISOString(),
      ...
      {
        uid: 'worker-007',
        email: 'paul@peninsulaequine.com.au',
        displayName: 'Paul (Available Position)',
        role: 'worker',
        password: 'peninsula25',
        createdAt: new Date().toISOString(),
        approvedAt: new Date().toISOString(),
      ...
      {
        uid: 'worker-008',
        email: 'ben@peninsulaequine.com.au',
        displayName: 'Ben (Available Position)',
        role: 'worker',
        password: 'peninsula25',
        createdAt: new Date().toISOString(),
        approvedAt: new Date().toISOString(),
      ...
      {
        uid: 'worker-009',
        email: 'chris@peninsulaequine.com.au',
        displayName: 'Chris (Available Position)',
        role: 'worker',
        password: 'peninsula25',
        createdAt: new Date().toISOString(),
        approvedAt: new Date().toISOString(),
